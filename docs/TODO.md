...
* Add buttons for forward (next folder), back (previous folder), up (parent folder) &check;, home (home folder) &check;, and refresh (same folder)
...
* Add buttons for adding, permanently deleting, and trashing files and folders
